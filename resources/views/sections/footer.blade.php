            ...
            <div class="pb-[60px] pt-20 lg:pb-20 lg:pt-[100px] xl:pt-[120px]">
                ...
                <div class="container-default">
                    ...
                    <div class="flex flex-wrap items-center justify-center text-center lg:text-left lg:justify-between gap-8">
                        ...
                        <!-- Section Block -->
                        <a href="/" class="btn is-blue is-rounded btn-animation is-large group"><span>Find Vet Clinic</span></a>
                    </div>
                    <!-- Section Wrapper -->
                </div>
                <!-- Section Container -->
                    ...
                    <div class="grid gap-x-16 gap-y-10 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-[1fr_repeat(3,_auto)] xl:gap-x-24 xxl:gap-x-[134px]">
                        ...
                        <div class="flex flex-col gap-y-7 md:col-span-1 lg:col-span-1">
                            ...
                            <ul class="flex flex-col gap-y-[10px] capitalize">
                                <li>
                                    <a href="index.php" class="hover:opcity-100 underline-offset-4 opacity-80 transition-all duration-300 ease-linear hover:underline">Home</a>
                                </li>
                                <li>
                                    <a href="about.php" class="hover:opcity-100 underline-offset-4 opacity-80 transition-all duration-300 ease-linear hover:underline">About Us</a>
                                </li>
                                <li>
                                    <a href="services.php" class="hover:opcity-100 underline-offset-4 opacity-80 transition-all duration-300 ease-linear hover:underline">Services</a>
                                </li>
                                <li>
                                    <a href="pricing.php" class="hover:opcity-100 underline-offset-4 opacity-80 transition-all duration-300 ease-linear hover:underline">pricing</a>
                                </li>
                                <li>
                                    <a href="contact.php" class="hover:opcity-100 underline-offset-4 opacity-80 transition-all duration-300 ease-linear hover:underline">Contact</a>
                                </li>
                            </ul>
                        </div>
                        <!-- Footer Widget Item -->
                        ...
                        <div class="flex flex-col gap-y-6 md:col-span-1 lg:col-span-1">
                            ...
                            <ul class="flex flex-col gap-y-[10px] capitalize">
                                <li>
                                    <a href="signup.php" class="hover:opcity-100 underline-offset-4 opacity-80 transition-all duration-300 ease-linear hover:underline">Signup</a>
                                </li>
                                <li>
                                    <a href="login.php" class="hover:opcity-100 underline-offset-4 opacity-80 transition-all duration-300 ease-linear hover:underline">Login</a>
                                </li>
                                <li>
                                    <a href="error-404.php" class="hover:opcity-100 underline-offset-4 opacity-80 transition-all duration-300 ease-linear hover:underline">404 Not found</a>
                                </li>
                                <li>
                                    <a href="reset-password.php" class="hover:opcity-100 underline-offset-4 opacity-80 transition-all duration-300 ease-linear hover:underline">Password Reset</a>
                                </li>
                            </ul>
                        </div>
                        <!-- Footer Widget Item-->
            ...
            <div class="py-[18px]">
                ...
                <div class="container-default">
                    <div class="text-center text-white text-opacity-80">
                        &copy; Copyright 2024, All Rights Reserved by <a class="brand" href="{{ home_url('/') }}"> <b>{!! $siteName !!}</b></a>
                    </div>
                </div>
                <!-- Section Container -->
            </div>

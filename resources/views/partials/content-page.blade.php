                  ...
                  <div class="jos">
                      ...
                      <ul class="grid gap-[34px]">
                          ...
                          <li class="accordion-item accordion-solid-shadow active">
                              <div class="overflow-hidden rounded-[10px] border-2 border-ColorDarkBlue bg-white p-[30px]">
                                  <!-- Accordion Header -->
                                  <div class="accordion-header flex justify-between gap-6 text-xl font-semibold text-ColorDarkBlue">
...
<div class="section-space">
  <div class="container-custom has-container-custom">
    ...
    <div class="grid justify-items-center md:grid-cols-4 sm:grid-cols-2 min-[320px]:grid-cols-2 gap-4 bg-ColorDarkBlue text-white p-10 rounded-xl lg:mx-20 z-10">

                ...
                <div class="grid items-center justify-center gap-[60px] md:grid-cols-[1fr_minmax(0,_0.6fr)]">
                    ...
                    <div class="jos">
                        <div class="mx-auto mb-6 max-w-xl lg:max-w-2xl xl:max-w-3xl xxl:max-w-[1076px]">
                            <h1
                                class="mb-6 font-Sora text-[40px] font-semibold leading-none -tracking-[1px] text-ColorDarkBlue sm:text-5xl lg:text-6xl xl:text-[76px] xxl:text-[90px]">
                                {{ get_field('heading') }}
                            </h1>
                        </div>
                    ...
                    <!-- Hero Image Block -->
                    <div class="relative">
                        <img src="{{ get_field('hero_image') }}" alt="hero-img" width="455" height="548"
                            data-jos_animation="zoom-in-down" class="mx-auto md:rotate-[5deg] hero-img-main" />

                        <!-- Hero Image Shape - 1 -->
                        <img src="@asset('images/elements/hero-12-shape-1.svg')" alt="hero-12-shape-1" width="56" height="81"
                            class="absolute -left-20 bottom-0 hidden md:inline-block lg:-left-28" />
                        <!-- Hero Image Shape - 2 -->
                        <img src="@asset('images/elements/hero-12-shape-2.svg')" alt="hero-12-shape-2" width="55" height="68"
                            class="absolute -right-16 -top-8 hidden md:inline-block" />
                    </div>
                    <!-- Hero Image Block -->
                </div>
                <!-- Hero Area -->
